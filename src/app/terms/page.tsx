    ...
    <section className="container mx-auto max-w-3xl py-12 md:py-16 lg:py-20">
      ...
      <div className="space-y-6">
        ...
        <div className="text-muted-foreground space-y-6">
          ...
          <p>
            Welcome to Schedule Calculator. These Terms of Service govern your
            use of our website and services operated by Verkleckert.
          </p>
          ...
          <p>
            I reserve the right to modify or replace these Terms at any time. It

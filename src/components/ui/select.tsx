  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `
        ...
        bg-background text-foreground border-input flex h-9 w-full min-w-0 items-center justify-between rounded-md
        border px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none
        dark:bg-input/30
